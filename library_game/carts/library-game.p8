...
function life_one_update()
 if #life_one_index!=0 then
  for life_one in all(life_one_index) do
   ...
   if not life_one.top then
    if life_one.y>life_one.start_height-life_one.max_height then
     life_one.y-=.01
     life_one.top=true
    end
   elseif life_one.top then
    if life_one.y<life_one.start_height then
     life_one.y+=.01
     life_one.top=false
    end
   end
...

...

